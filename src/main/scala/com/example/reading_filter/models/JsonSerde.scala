...
// All copied from the below repo
// https://github.com/azhur/kafka-serde-scala/blob/master/kafka-serde-circe/src/main/scala/io/github/azhur/kafkaserdecirce/CirceSupport.scala
